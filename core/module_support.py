...
class ModuleSupport(object):
    ...
    def dns_set_method(cls, router_plugin_info):
        """
        using router_pluin_info return by crawler to determine dns set plugin name
